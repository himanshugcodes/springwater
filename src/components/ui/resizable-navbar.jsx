...
//     <a
//       href="#"
//       className="relative z-20 mr-4 flex items-center space-x-2 transition-all duration-300"
//     >
//       <img
//         src={
//           visible
//             ? "https://www.finessse.digital/assets/images/logo.svg" // 👈 small logo (on scroll)
//             : "https://assets.aceternity.com/logo-dark.png" // 👈 full logo (top)
//         }
//         alt="logo"
//         className={cn(
//           "transition-all duration-300",
//           visible ? "h-6 w-6" : "h-8 w-8"
//         )}
//       />

//       {!visible && (
//         <span className="font-medium text-black dark:text-white transition-opacity duration-300">
//           Startup
//         </span>
//       )}
//     </a>
